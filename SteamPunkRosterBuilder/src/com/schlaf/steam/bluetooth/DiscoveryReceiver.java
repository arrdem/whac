...
import com.schlaf.steam.bluetooth.BeddernetInfo;;
...
public class DiscoveryReceiver extends BroadcastReceiver {
        ...
        public DiscoveryReceiver(MyBeddernetService parent) {
        	beddernetService = parent;
        }
        ...
        public void onReceive(Context context, Intent intent) {
                ...
                if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                        ...
                        beddernetService.notifyDiscoveryFinished();
