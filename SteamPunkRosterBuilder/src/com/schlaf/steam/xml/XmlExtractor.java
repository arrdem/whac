...
public class XmlExtractor {
	...
	public boolean extractImportedFileFromInternet(Context applicationContext, StringBuffer content) {
	...
	/**
	 * charge la partie "factions" du fichier xml à partir du parser positionné
	 * sur le tag de début
	 * 
	 * @param xpp
	 */
	...
	/**
	 * charge la partie "faction" du fichier xml à partir du parser positionné
	...
	/**
	 * charge la partie "army" du fichier xml à partir du parser positionné sur
	...
	/**
	 * charge la partie "warcasters" du fichier xml à partir du parser
	...
	/**
	 * charge la partie "Warlocks" du fichier xml à partir du parser
	 * positionné sur le tag de début
	 * 
	 * @param xpp
	 * @param faction 
	...
	/**
	 * charge la partie "warjacks" du fichier xml à partir du parser positionné
	 * sur le tag de début
	 * 
	 * @param xpp
	 */
	...
	/**
	 * charge la partie "battle engine" du fichier xml à partir du parser positionné
	 * sur le tag de début
	 * 
	 * @param xpp
	 */
	...
	private Warcaster loadWarcaster(XmlPullParser xpp)
		...
		String generationId = xpp.getAttributeValue(null, "generationId");
...
//		loadWeapons(xpp,model);
	...
	/**
	 * charge la partie "solo" du fichier xml à partir du parser positionné
	 * sur le tag de début d'un solo
	 * 
	 * @param xpp
	 * @throws IOException
	...
	/**
	 * charge la partie "unit" du fichier xml à partir du parser positionné
...
//		loadFullText(xpp,unit);
		...
		while (!(eventType == XmlPullParser.END_TAG && UNIT_TAG.equals(xpp
			...
			// si l'unité comprend des modèles variés, on les ajoute à la volée
	...
	/**
	 * charge la partie "warjack" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une faction
	 * 
	 * @param xpp
	 * @throws IOException
...
//		loadWeapons(xpp, model);
	...
	/**
	 * charge la partie "warbeast" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une faction
	 * 
	 * @param xpp
	 * @throws IOException
...
//		loadWeapons(xpp, model);
	...
	/**
	 * charge la partie "basestats" du fichier xml à partir du parser positionné
		...
		while (!(eventType == XmlPullParser.END_TAG && BASESTATS_TAG.equals(xpp
			...
			if (eventType == XmlPullParser.START_TAG && BASESTATS_TAG.equals(xpp.getName())) {
				...
				if (extractFromString(hitpoints) == 0) {
					...
					container.setHitpoints(new ModelDamageLine(extractFromString(hitpoints), 0));
				}
...
//			}
	...
	/**
	 * charge la partie "feat" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renseigne l'unité concernée
	 * 
	 * @param xpp
	 * @throws IOException
	...
	/**
	 * charge la partie "fullText" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renseigne l'unité concernée
	 * 
	 * @param xpp
	 * @param alreadyOnTag if true, don't "next()" on parser. allows calling method to handle the presence or absence of tag
	 * @throws IOException
	 * @throws XmlPullParserException
	 */	
	...
	/**
	 * charge la partie "UA" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renseigne l'unité concernée
	 * 
	 * @param xpp
	 * @throws IOException
	...
	/**
	 * charge la partie "WA" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renseigne l'unité concernée
	 * 
	 * @param xpp
	 * @throws IOException
	...
	/**
	 * charge la partie "melee_weapon" du fichier xml à partir du parser positionné
	...
	/**
	 * charge la partie "ranged_weapon" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renvoit l'objet renseigné
	 * 
	 * @param xpp
	 * @throws IOException
...
//			weapon.setRange(extractFromString(rng));
	...
	/**
	 * charge la partie "mount_weapon" du fichier xml à partir du parser positionné
	 * sur le tag de début d'une ligne, et renvoit l'objet renseigné
	 * 
	 * @param xpp
	 * @throws IOException
