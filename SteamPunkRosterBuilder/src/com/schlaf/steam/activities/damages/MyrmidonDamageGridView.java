...
public class MyrmidonDamageGridView extends DamageBaseView implements ColumnChangeNotifier {
	...
	List<Coords> coords = new ArrayList<MyrmidonDamageGridView.Coords>(50);
	List<CoordsColumn> coordsColumnIndicator = new ArrayList<MyrmidonDamageGridView.CoordsColumn>(6);
