...
public class ViewBattleResultActivity extends SherlockFragmentActivity implements ViewBattleResultActivityInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle("Battle result");
