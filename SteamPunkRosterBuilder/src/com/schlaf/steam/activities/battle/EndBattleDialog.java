 ...
 * 
 */
public class EndBattleDialog extends SherlockDialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		builder.setMessage(getResources().getString(R.string.savebattle));
		...
		builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
				...
				String players = sharedPref.getString(PreferenceConstants.OPPONENTS_LIST, "");

				ArrayList<String> opponents = new ArrayList<String>();
				StringTokenizer stk = new StringTokenizer(players, ";");
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw new ClassCastException(activity.toString()
                    + " must implement EndBattleListener");
        }
    }
