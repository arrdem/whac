 ...
 * 
 */
public class ViewCardActivity extends SherlockFragmentActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getSupportMenuInflater().inflate(R.menu.view_card_menu, menu);
        return true;
    }	
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getSupportActionBar().setTitle(getArmyElement().getFullName());
